...
const mountains: Mountain[] = [
{
	...
	description:
	"早池峰山は北上山地の主峰で、日本百名山のひとつ。固有種を含む高山植物の宝庫として知られ、山頂からは北上山地と奥羽山脈の大展望が広がります。春から初夏は花の時期、秋には紅葉、冬には樹氷と、四季折々に表情を変える山です。<br /><br />さらに、この山は日本でも最古級の地層が地表に現れている山としても知られ、約5億年前の古生代の岩石と蛇紋岩が広く分布しています。特殊な地質環境のもとで、早池峰ウスユキソウやナンブトラノオなどの固有種をはじめ、多くの希少な植物が適応しながら生きてきました。南側は草原状の明るい尾根が広がりますが、北側ではヒノキアスナロやアオモリトドマツ、コメツガなどの針葉樹林が山頂近くまで続き、厳しくも豊かな自然環境の対比を感じることができます。",
	subImages: [
