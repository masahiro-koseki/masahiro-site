      ...
      ({
        ja: {
          nav: { home: "ホーム", book: "写真集", portfolio: "ポートフォリオ", about: "プロフィール", news: "お知らせ", contact: "お問い合わせ" },
					hero: { title: "山と自然に魅せられて", subtitle: "岩手・東北の山と四季を写した日本の自然風景写真。", poem: "朝の光に導かれ、山の息づかいに心を寄せる。<br />その瞬間の静けさを、そっと写しとった記録。", cta1: "写真集を見る", cta2: "作品をみる" },
          book: {
            lead: "写真集『山と自然に魅せられて』",
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <Section id="home" className="pt-12 pb-0">
		...
		<Section id="book" className="section-spacing scroll-mt-14 md:scroll-mt-20">
		<H2>{t.book.lead}</H2>
		...
		<Section id="portfolio" className="section-spacing scroll-mt-14 md:scroll-mt-20">
		...
		<Section id="about" className="section-spacing scroll-mt-14 md:scroll-mt-20">
		<H2>{t.about.title}</H2>
		<AboutSection lang={lang} about={t.about} />
		</Section>

		<Section id="news" className="section-spacing scroll-mt-14 md:scroll-mt-20">
		<H2>{t.news.title}</H2>
		<NewsSection lang={lang} news={t.news} />
		</Section>

		<Section id="contact" className="section-spacing scroll-mt-14 md:scroll-mt-20">
